...
df = pd.read_csv('~/code/giadapi/crypto/data/all_columns_daily_090323.csv')
...
with col_1b:
    ...
    #Histogram
    df_lastday = df_30_clean.iloc[-1:]
    fig_1 = go.Figure(data=[
        go.Bar(name='negative', x=df_lastday['date'], y=df_lastday['negative'], marker_color='#4284CC'),
        go.Bar(name='positive', x=df_lastday['date'], y=df_lastday['positive'], marker_color='#FF914D')
        ])
...
with st.container():
    ...
    fig = go.Figure(data=[
        go.Bar(name='negative', x=df_30_clean['date'], y=df_30_clean['negative'], marker_color='#4284CC'),
        go.Bar(name='positive', x=df_30_clean['date'], y=df_30_clean['positive'], marker_color='#FF914D')
        ])
