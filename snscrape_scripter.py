...
if __name__ == "__main__":
    snscrape(num_tweets=149,start_date='2022-09-24T06:00:00',end_date='2022-12-24T06:00:00', hour_delta=8,min_gap=10,filename='24-09-22_to_24-12-23.csv',make_csv=True)
